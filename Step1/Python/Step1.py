...
def plot_body_angular_velocity(t, omega_body):
    ...
    plt.plot(t, omega_1)
    plt.xlabel('Time (s)')
    plt.ylabel('omega b1 (rad/s)')
    plt.title('Ang. Velocity omega b1 over Time')
    plt.grid()

    plt.subplot(3,1,2)
    plt.plot(t, omega_2)
    plt.xlabel('Time (s)')
    plt.ylabel('omega b2 (rad/s)')
    plt.title('Ang. Velocity omega b2 over Time')
    plt.grid()

    plt.subplot(3,1,3)
    plt.plot(t, omega_3)
    plt.xlabel('Time (s)')
    plt.ylabel('omega b3 (rad/s)')
    plt.title('Ang. Velocity omega b3 over Time')
    plt.grid()
